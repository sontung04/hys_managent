                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <label class="col-lg-2 col-form-label" >Chọn khóa học: <span class="text-danger">*</span></label>
                                        <div class="form-group col-lg-5">
                                            <select class="" id="selectCourse" multiple="multiple" data-placeholder="--- Chọn khóa học ---"
                                                    style="width: 100%;">
                                            </select>
                                        </div>
                                        <div class="col-lg-5">
            ...
            <!-- Modal body -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <label class="col-lg-3 col-form-label" for="course_id">Khóa học: <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <label class="col-lg-3 col-form-label" for="name">Tên bài giảng: <span class="text-danger">*</span></label>
                                <div class="form-group col-lg-9">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <textarea type="text" name="homework" id="homework" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
